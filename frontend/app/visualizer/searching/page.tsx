...
export default function SearchingVisualizersPage() {
  const algorithms = algorithmRegistry.filter((algorithm) => algorithm.category === "searching");
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="space-y-2 border-b border-warm-border pb-8">
        ...
        <h1 className="font-display text-4xl tracking-tight text-ink sm:text-5xl">Searching Algorithms</h1>
      </section>
